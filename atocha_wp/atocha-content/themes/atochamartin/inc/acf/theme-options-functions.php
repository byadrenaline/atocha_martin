...
if( ! function_exists( 'byadr_contacto' ) ){
	...
	function byadr_contacto(){
		$telefono_1 = get_field('telefono_1', 'option');
		$telefono_2 = get_field('telefono_2', 'option');
		$email = get_field('Email', 'option');

		if($email || $telefono_1 || $telefono_2 ):
		?>
		<div class="footer__contacto">
			<p>CONTACTO</p>
			
			<?php if($telefono_1): ?>
				<p><?php echo $telefono_1; ?></p>
			<?php endif ?>

			<?php if($telefono_2): ?>
				<p><?php echo $telefono_2; ?></p>
			<?php endif ?>
