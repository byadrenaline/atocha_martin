	...
	function byadr_layout_builder(){
		...
		if($lb):
			...
			if( have_rows('layout_builder') ) : while(have_rows( 'layout_builder' )) : the_row();
				...
				// HERO 
				require get_template_directory() . '/inc/acf/lb-hero.php';
				...
				// CALL TO ACTION
				require get_template_directory() . '/inc/acf/lb-calltoaction.php';
				...
				// EQUIPO
				require get_template_directory() . '/inc/acf/lb-equipo.php';

				// PREMIOS
				require get_template_directory() . '/inc/acf/lb-icon.php';
